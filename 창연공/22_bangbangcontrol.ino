...
// Servo adjustment
#define _DUTY_MAX 1988  // Servo angle: D degree
#define _DUTY_NEU 1261  // Servo angle: 0 degree
#define _DUTY_MIN 792   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 94 // Replace with |D - E| degree
#define _SERVO_SPEED 1000 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 750
...
{
  return 690 + ((-1) * 2.55 * a_value) + 2.34E-03 * a_value * a_value; // Replace this with the equation obtained from nonlinear regression analysis
}
