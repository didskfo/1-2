...
class Calculator(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.layoutList = [numLayout, opLayout, constLayout, funcLayout,]
        for i in range(1, 3):
            for j in range(2):
                mainLayout.addLayout(self.layoutList[2*i+j-2], i, j)
    ...
    def buttonClicked(self):
        self.errorList = ['Error!', 'ZeroDivisionError!', 'ValueError!']
